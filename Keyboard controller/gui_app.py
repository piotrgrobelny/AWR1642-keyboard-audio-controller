...
class MainWindow(QtWidgets.QWidget):
    ...
    def updateData(self):
        ...
        self.ui.lcdNumber.display(int(100 * kc.distance)) #show distance in real time
        self.data_plot.setData(kc.x, kc.y)
...
if __name__ == "__main__":
    kc.main() #start read and process data from radars
    import sys
